<div class="pdf_page_task_choice_container">
    ...
    <input type="number" min="1" max="20" step="1" placeholder="4" style="width:9%; margin:auto 0% auto 1%" name="task_quantity" value="<?=isset($_SESSION["preview"]["task_quantity"])?$_SESSION["preview"]["task_quantity"]:"4"?>">
</div>