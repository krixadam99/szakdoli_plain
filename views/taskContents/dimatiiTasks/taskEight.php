...
<label class="task_label">
    ...
    felett! A polinomok együtthatóit és a változó fokszámát a főegyütthatótól a konstans tagig haladva vesszővel elválasztva (együttható, változó fokszáma) alakban add meg (pl.: 2x<sup>2</sup>+3x+1 helyett írj (2,2),(3,1),(1,0)-t)!
</label>
...
<label class="task_label">
    ...
    felett! Az eredménypolinom együtthatóit és a változók fokszámát a főegyütthatótól a konstans tagig haladva vesszővel elválasztva (együttható, változó fokszáma) alakban add meg (pl.: 2x<sup>2</sup>+3x+1 helyett írj (2,2),(3,1),(1,0)-t)!
</label>
<div class="small_task_container">
    <?php 
