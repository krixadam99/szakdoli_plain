<?php
    ...
    $incorrect_parameters = $this->success_parameters;
    $correct_parameters = $this->error_parameters;
    $dimat_i_groups = [];
...
<body>
    ...
    <main>
        <?php if($status === "student"):?>
            <h1>Csoporthoz való csatlakozás hallgatóként</h1>
        <?php else:?>
            <h1>Csoporthoz való csatlakozás demonstrátorként</h1>
        <?php endif?>
        <hr>
    </main>
    ...
    <form id="group_addition_form" action="./index.php?site=validateGroupAddition" method="POST" style="margin: 2% 4%;width: 92%">
        <div>
            ...
            <?php if(isset($incorrect_parameters)):?>
                <?php if(in_array('wrong_1_no_such_subject',$incorrect_parameters)):?>
                    <label id="error_label">A kiválasztott tárgy nem létezik!</label>
                <?php elseif(in_array('wrong_1_no_subject_name',$incorrect_parameters)):?>
        ...
        <div id="subject_group_div" <?=(isset($correct_parameters["subject_name"]) && $correct_parameters["subject_name"]=="2")?"hidden":""?>>
            ...
            <div id="student_groups" <?=$status === "teacher"?"hidden":""?>>
            ...
            <div id="teacher_groups" <?= $status === "student"?"hidden":""?>>
